...
> 📌 **ผู้สอนควรปรับวันที่ในแผนภาพด้านล่างให้ตรงกับรอบที่จัดจริง** — ค่าที่ใส่ไว้เป็นเพียงตัวอย่างโครงสร้าง (วันเวิร์กช็อป → เลือกหัวข้อ 1 สัปดาห์ → ทำงาน 2 สัปดาห์ → ส่งงาน)

```mermaid
gantt
    title กำหนดส่งงาน (ตัวอย่าง — ปรับวันที่ตามรอบจริง)

...
เอกสารชุดนี้เขียนเป็น Markdown ล้วน ใช้ **Mermaid** สำหรับ diagram ทั้งหมด (48 diagram) จึงเปิดดูได้โดยตรงบน GitHub และ GitLab **โดยไม่ต้องมี build step หรือ static site generator**
